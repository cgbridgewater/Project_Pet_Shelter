...
import AdoptForm from "./Sub/AdoptForm";
...
const Detail = () => {
    ...
    const [ setGetErrors] = useState("null");
    ...
    return (
        <div>
            ...
            <div className="Background">
                ...
                <br/>
                <Link  to="/">
                    <img className='Lost'src="https://img.freepik.com/premium-vector/animal-shelter-house-cartoon-illustration-containing-animals-adoption-flat-hand-drawn-style_2175-6053.jpg?w=2000" alt="pet shelter icon" />        
                </Link>
            </div>
            ...
            <div>
                ...
                {/* content */}
                    ...
                    <div className="DetailContainer" style={{display:"flex", justifyContent:"space-evenly",flexWrap:"wrap", alignItems:"center",margin:"20px auto",padding:"2%", minHeight:"35%", width:"70%", minWidth:"370px",backgroundImage:"url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQt0KsyQv5YwZXalff-qFUxzk_C_rL80pkG3w&usqp=CAU)",backgroundSize:"cover", border:"2px solid #073DAA", borderRadius:"15px"}}>
                        {/* pet image */}
                        <img style={{width:"350px", height:"auto",border:"2px solid #073DAA", borderRadius:"10px"}} src={petImage} alt="pet" loading="lazy" />
                        {/* pet details */}
