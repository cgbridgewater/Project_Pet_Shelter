    ...
    return (
        ...
        <div style={{ minHeight:"70vh",padding:"20px 10px"}}>
            ...
            <div className="Background">
                ...
                <br/>
                <a  href="/">
                    <img className='Lost'src="https://img.freepik.com/premium-vector/animal-shelter-house-cartoon-illustration-containing-animals-adoption-flat-hand-drawn-style_2175-6053.jpg?w=2000" alt="Pet Shelter" />
                </a>
            </div>
                    ...
                    <div style={{marginTop:"10px",display:"flex", justifyContent:"space-evenly", flexWrap:"wrap"}} >
                        ...
                        <div>
                            ...
                            <div className='DropdownContainer' style={{border:"2px solid #073DAA",boxShadow:"0 8px 12px 0 rgba(0, 0, 0, 0.80)"}}>
                                <img style={{height:"150px", width:"280px", margin:0}}  src={NewBestFriend} alt="Meet your new best friend today"  loading='lazy'/>
                                        ...
                                        <div className="pet">
                                            <div className="pet-image desktop-only">
                                                <Link to={`/petshelter/${pet._id}`}>
                                                    <img src={pet.petImage} alt="pet" loading='lazy'/>
                                                </Link>
                                            </div>
