    ...
    return(
        <div className="Background">
            <div className="PageContainer" style={{width:"60%", margin:"15px auto"}}>
                ...
                <div className="LeftAboutMe">
                    <p style={{textAlign:"start", fontSize:"18px", fontWeight:800, color:"#073DAA"}}>
                        <span style={{fontSize:" 200%", fontWeight: 700, lineHeight:"80%", color:"#073DAA"}}>W</span>
                            elcome to my Project Pet Shelter site. This is a single page app utilizing the MERN stack, and has a handfull of features built into it:
                    </p>
                ...
                <img className="RightAboutMe" src="https://i.pinimg.com/originals/60/a0/f1/60a0f10e9227fa654939884d40c2d8f3.gif" alt="dog" />
                </div>
