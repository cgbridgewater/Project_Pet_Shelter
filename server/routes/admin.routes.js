...
module.exports = (app) => {
    // app.get('/api/user', authenticate, AdminController.findAll);  // created for expansion
    ...
    // app.put('/api/user/:id', AdminController.update);  // created for expansion
    // app.delete('/api/user/:id', AdminController.delete);  // created for expansion 
}